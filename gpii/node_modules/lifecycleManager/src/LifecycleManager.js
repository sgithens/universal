   ...
   //   http://wiki.gpii.net/index.php/Transformer_Payload_Examples
    gpii.lifecycleManager.invokeSettingsHandlers = function (solutionId, settingsHandlers) {
        ...
        return fluid.transform(settingsHandlers, function (handlerSpec) {
            ...
            // TODO move this back below the actual setting setup
            //console.log("And now the journal...");
            //gpii.journal.logSolutionStart("Doing handler: " + solutionId);

            var settingsHandlerPayload =
                gpii.lifecycleManager.specToSettingsHandler(solutionId,
                    handlerSpec);
            
console.log("The handler spec type is: " + handlerSpec.type);
            ...
            //console.log("We just set the handler: " + solutionId);
            ...
            var invariant = fluid.model.transform(handlerSpec,
                gpii.lifecycleManager.invariantSettings);
console.log("The snapshotted things: " + JSON.stringify(settingsSnapshot, null, "  "));
            var fullSnapshot = $.extend(true, {}, handlerSpec, settingsSnapshot);
            gpii.journal.logSolutionStart(JSON.stringify(fullSnapshot, null, "  "));
            return fullSnapshot;
...
console.log("Stopping: " + solution.id);
